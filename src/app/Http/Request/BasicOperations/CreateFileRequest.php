...
class CreateFileRequest extends RequestWithPath
{
    ...
    public function prepareForValidation()
    {
        ...
        $this->merge([
            'name'    => $this->pathSanitizer->sanitizeFileName($directoryName),
        ...
        return array_merge(parent::rules(), [
            'name' => [
                ...
                function (string $_, $value, callable $fail) {
                    if (preg_match('/[\/\\\\]/', $value)) {
                        $fail(trans('storage-manager::storage-manager.validation.invalid_file_name'));
                    }
                },
            ],
            'content' => [
