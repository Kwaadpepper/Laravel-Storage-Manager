...
import { useDeleteFileViewModel } from "./delete-viewmodel";

interface DeleteFileModalProps {
}

export default function DeleteFileModal(_: Readonly<DeleteFileModalProps>) {
  const vm = useDeleteFileViewModel()
    ...
    <dialog className="modal" onClose={onClose} ref={dialogRef}>
      <div className="modal-box">
        ...
        <div className="py-4">
          ...
          <p className="text-sm text-base-content/60 mt-1 break-all">{vm.targetFilePath}</p>
        </div>
